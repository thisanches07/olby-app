...
const PLANS = [
  ...
  },
  {
    ...
    features: [
      ...
      { ok: true, text: "Etapas, atividades e despesas" },
      { ok: true, text: "Orçamentos manuais e fornecedores" },
      { ok: true, text: "Relatórios dentro do limite mensal" },
    ],
  ...
  },
  {
    ...
    features: [
      ...
      { ok: true, text: "Importação de orçamentos por IA" },
      { ok: true, text: "Importação de cronogramas do MS Project" },
      { ok: true, text: "Análises e relatórios ilimitados" },
