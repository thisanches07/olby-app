  ...
  switch (permissionState) {
    ...
    case "denied":
      return {
        ...
        description:
          "Você recusou o pedido no sistema. O app tenta solicitar a permissão no momento certo, conforme o aparelho permitir.",
        tone: "#FEF3C7",
    ...
    case "blocked":
      return {
        ...
        description:
          "O sistema não permite pedir novamente no app. Reative os alertas diretamente nas configurações do aparelho, se desejar.",
        tone: "#FEE2E2",
        icon: "mobile-off",
    ...
    default:
      return {
        ...
        description:
          "O pedido nativo é feito automaticamente logo após o login, para alinhar a ativação do aparelho desde o início da conta.",
        tone: "#DBEAFE",
      ...
      >
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.listItem}>
            Novas tarefas e tarefas concluídas
          </Text>
          <Text style={styles.listItem}>Novos registros diários de obra</Text>
          <Text style={styles.listItem}>Mudanças de status do projeto</Text>
        </View>
        ...
        {shouldOpenSettings ? (
          <View style={styles.card}>
            ...
            <Text style={styles.bodyText}>
              Para voltar a receber alertas, reative as notificações nas
              configurações do sistema deste aparelho.
            </Text>
            <Pressable
